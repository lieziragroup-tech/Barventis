...
export default function SuperAdminPanel({ tab }) {
  ...
  return (
    <div style={{ padding: '4px' }}>
                  ...
                  <div key={tmpl.id} className="glass-card" style={{ padding: '20px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                        ...
                        <h4 style={{ margin: 0, color: 'white', fontWeight: 800 }}>{tmpl.display_name}</h4>
                      </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', background: 'rgba(255,255,255,0.02)', padding: '14px', borderRadius: '10px', border: '1px solid var(--border)' }}>
                ...
                <div style={{ flex: 1, minWidth: '200px', position: 'relative' }}>
                  <input
                    ...
                    style={{
                      width: '100%', padding: '8px 12px 8px 36px', background: 'rgba(15,23,42,0.6)',
                      border: '1px solid var(--border)', borderRadius: '6px', color: '#fff', fontSize: '0.825rem', outline: 'none'
                    }}
                  />
      ...
      {showTenantModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: '20px' }}>
          <div className="glass-card" style={{ width: '100%', maxWidth: '460px', padding: '28px', border: '1px solid rgba(245,158,11,0.2)' }}>
            <h4 style={{ margin: '0 0 16px 0', color: 'white', fontWeight: 800, fontSize: '1.1rem' }}>
              ...
              {selectedTenant && (
                <div style={{ background: 'rgba(255,255,255,0.02)', padding: '12px', borderRadius: '8px', border: '1px solid var(--border)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
                    ...
                    <span style={{ fontSize: '0.8rem', fontWeight: 700, color: 'white' }}>Kunci Edit Periode Bulanan</span>
                  </div>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: '1px solid var(--border)', borderRadius: '6px', color: '#fff', fontSize: '0.8rem', outline: 'none'
                        }}
                      />
                    </div>
                    <div style={{ flex: 1 }}>
      ...
      {showTemplateModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: '20px' }}>
          <div className="glass-card" style={{ width: '100%', maxWidth: '520px', padding: '28px', border: '1px solid rgba(245,158,11,0.2)' }}>
            <h4 style={{ margin: '0 0 16px 0', color: 'white', fontWeight: 800, fontSize: '1.1rem' }}>
